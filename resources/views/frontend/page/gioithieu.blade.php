        ...
        <div id="content">
          @if(Session::has('flag'))
            ...
            <div class="our-history">
                <h2 class="text-center wow fadeInDown">Sự hình thành</h2>
                ...
                <div class="history-slider">
                    ...
                    <div class="history-slides">
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history1.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
                                    ...
                                    <p> CB BROTHERS - Thế giới game thủ - Chuyên cung cấp, phân phối gaming gear chính hãng</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history2.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
                                    ...
                                    <div class="space20">&nbsp;</div>
                                    <p> Sau năm đầu tien kinh doanh, CB đã đạt doanh thu 3 tỷ đồng, một con số
                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history3.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history4.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history5.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history6.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-sm-2">
                                    <img src="source/frontend/assets/dest/images/history7.jpg" alt="">
                                </div>
                                <div class="col-sm-10">
            ...
            <div class="row">
                <div class="col-sm-2 col-sm-push-2">
                    <div class="beta-counter">
                        ...
                        <p class="beta-counter-value timer numbers" data-to="19855" data-speed="2000">1995</p>
                ...
                <div class="col-sm-2 col-sm-push-2">
                    <div class="beta-counter">
                        ...
                        <p class="beta-counter-value timer numbers" data-to="3568" data-speed="2000">1995</p>
                ...
                <div class="col-sm-2 col-sm-push-2">
                    <div class="beta-counter">
                        ...
                        <p class="beta-counter-value timer numbers" data-to="258934" data-speed="2000">141995</p>
