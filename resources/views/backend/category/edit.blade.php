...
@section('contentadmin')
    ...
    <div id="rightSide">
        ...
        <div class="wrapper">
            ...
            <!-- Form -->
            <form enctype="multipart/form-data" method="post" action="admin/category/edit/{{$cate->id}}" id="form"
                  class="form">
                        ...
                        <div class="tab_container">
                            <div class="tab_content pd0" id="tab1" style="display: block;">
                                <div class="formRow">
                                    ...
                                    <div class="formRight">
                                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_name"
                                                                    value="<?php echo $cate->ten_loai_sp ?>" name="name"></span>
                                ...
                                <div class="formRow">
                                    ...
                                    <div class="formRight">
                                        <span class="oneTwo" >
                                            <input type="text" id="param_name" name="description" value="{{$cate->mo_ta}}">
                                        </span>
                                        <span class="autocheck" name="name_autocheck"></span>
                                        <div class="clear error" name="name_error"></div>
                                    </div>
